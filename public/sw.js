...
// Grid images are now ~15KB thumbnails (Transformations zone), so a large cap
// still fits a modest budget (~1800 × ~15KB ≈ 27MB) and leaves far more sets
// available offline. Paired with the first-launch thumbnail prewarm.
const IMG_CACHE_MAX = 1800;
...
const STATIC_ASSETS = [
  ...
  '/icon-glow-512.png',
  '/brand-brick-transparent.png',
  '/img/vault-steel.webp',
  '/img/vault-floor.webp',
  '/img/vault-door.webp',
  '/env.js',
  '/js/app.js',
  '/js/theme.js',
  ...
  '/js/router.js',
  '/js/route-meta.js',
  '/js/components/legal-sheet.js',
  '/js/components/empty-vault-brick-3d.js',
  ...
  '/js/lib/insurance-report.js',
  '/js/lib/minifig-holding.js',
  '/js/lib/subcollections.js',
  '/js/lib/subcollection-storage.js',
  '/js/views/subcollections.js',
  '/js/lib/collection-room.js',
  '/js/views/collection-room.js',
  '/js/components/collection-room-scene.js',
  '/js/components/collection-room-video-intro.js',
  '/js/lib/admin-issues.js',
  '/js/lib/sold-evidence.js',
  '/js/lib/part-out-decision.js',
  '/js/lib/filter-summary.js',
  '/js/lib/fig-avatar.js',
  '/js/lib/partner-attribution.js',
  '/js/lib/i18n.js',
  '/js/locales/en.js',
  '/js/locales/de.js',
  '/js/locales/es.js',
  ...
  '/js/lib/app-lock.js',
  '/js/lib/horizontal-rail.js',
  '/js/lib/native-net.js',
  '/js/lib/native-push.js',
  '/js/lib/native-share.js',
  '/js/lib/native-file-export.js',
  '/js/lib/native-widget.js',
  '/js/lib/amazon-affiliate.js',
  '/js/lib/morphdom.js',
  '/js/lib/local-ai.js',
  '/js/lib/scan-ocr.js',
  '/js/lib/advisor-local-ai.js',
  '/js/lib/provider-credentials.js',
  '/js/components/sheet.js',

  '/js/components/kids-pin.js',
