...
export const en = {
  ...
  portfolio: {
    ...
    stackVault: 'Stack the Vault',
    stackVaultLabel: 'Play Stack the Vault in 3D',
    stackVaultInstructions: 'Tap, click, or press Space when the brick lines up. Stack 6 in 15 seconds.',
    stackVaultProgress: '{placed} of {target} bricks stacked. {seconds} seconds left.',
    stackVaultMiss: 'Missed — line up the next brick and try again.',
    stackVaultWon: 'Vault stacked! Add your first set to make it real.',
    stackVaultLost: 'Time’s up. Add your first set and start the real vault.',
