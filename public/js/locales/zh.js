...
export const zh = {
  ...
  bvAccount: {
    ...
    insNoteTitle: '关于这些估值',
    insColNumber: '编号',
    insPdfCounts: '{sets} 套 · {figs} 个人仔 · 以 {currency} 计价',
    insPdfCountsNoFigs: '{sets} 套 · 以 {currency} 计价',
    insPdfNote: '估值为截至 {date} 的未拆封套装市场估计，综合 BricksVault 追踪的各来源近期成交与在售信息得出，并非专业评估。方法：bricksvault.app/methodology.html',
    insPdfPage: '第 {page} 页，共 {pages} 页',
    insPdfGenerated: '由 BricksVault 生成',
    insLoadFailed: '未能加载全部收藏。完整加载之前不会导出任何内容。',
    insColFigs: '人仔',
    insColValue: '价值',
    insColPaid: '支付',
    insColQty: '数量',
