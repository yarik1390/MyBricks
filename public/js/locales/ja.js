...
export const ja = {
  ...
  bvCommunity: {
    kidsPinLabel: '保護者用PIN',
    kidsBack: 'ぼくのブロックにもどる',
    kidsBadges: 'バッジ・{total}こ中{n}こ',
    kidsEmpty: 'はじめてのセットをスキャンして、コレクションをはじめよう！',
    kidsMySets: 'ぼくのセット',
    kidsScan: '新しいセットをスキャン',
    kidsXpLabel: '次のレベルまでの進み具合',
    kidsExitLabel: 'キッズモードを終了（おとな用）',
    kidsGrownups: 'おとな用',
    kidsTitle: 'ぼくのブロック',
    kidsLevel: 'レベル{level}のビルダー',
    advTurnOn: 'オンにする',
    advOffBody: 'オンにすると、セットや価格、次に買うものについて質問できます。',
    advOffTitle: 'アドバイザーはオフです',
    advClear: '会話を消去',
    advSettings: 'AIエンジンとキー',
    advReportSub: '健全性・テーマ・廃番リスク・上位セットを端末上で算出',
    advReport: 'コレクションレポート',
    advSend: '送信',
    advPlaceholder: 'コレクションについて質問',
    advInputLabel: 'アドバイザーに質問',
    advKeyLink: 'キーを追加',
    advKeyTip: '無料のGeminiキーを追加すると、回答数の制限がなくなります。',
    advPromptTheme: 'テーマごとの調子は？',
    advPromptSell: '今月売るべきものは？',
    advPromptBuy: '少ない予算でのおすすめ',
    advPromptRetiring: 'もうすぐ廃番になるのは？',
    advAsk: 'コレクションについて質問しましょう',
    advRoom: 'もっと多くのテーマに分散できます。',
    advHealthy: 'テーマがバランスよく分散しています。',
    advOneTheme: 'すべて{theme}です。2つ目のテーマでリスクが分散されます。',
    advConcentrated: '評価額の{pct}%が{theme}に集中しています。別のテーマを加えるとリスクが分散されます。',
    advLeadSteady: '今のところ安定しています。',
    advLeadDown: '購入価格を下回っています。',
    advLeadGains: 'しっかり値上がりしています。',
    advOutOf: '100点中',
    advHealth: 'ポートフォリオの健全性',
    advConversation: 'アドバイザーとの会話',
    advMenu: 'アドバイザーのオプション',
    advSubLocal: 'あなたのコレクションを使用・端末上のAI',
    advSubCloud: 'あなたのコレクションを使用・クラウドAI',
    advTitle: 'アドバイザー',
    gameFootnote: '毎日UTC午前0時に新しいセット。価格はBricksVaultの市場価格です。',
    gameShare: '共有',
    gameOff: '{pct}%ずれ',
    gameRight: '正解',
    gameSoFar: 'ここまで{done}問中{right}問正解',
    gameBest: '最高 {best}',
    gameStreakOther: '{count}日連続',
    gameStreakOne: '{count}日連続',
    gameSeeScore: 'スコアを見る',
    gameNext: '次のセット',
    gameEnterGuess: '先に予想を入力してください',
    gameLockIn: '決定',
    gameHint: '市場価格の±20%以内なら正解です。',
    gameAdjust: '予想を調整',
    gameGuessPh: 'あなたの予想',
    gameQuestion: '未開封で今いくら？',
    gameNotReadyBody: 'もう少しお待ちください。毎日UTC午前0時に5つの新しいセットが登場します。',
    gameNotReadyTitle: '今日のゲームはまだ準備中です',
    gameLoadFailedTitle: '今日のゲームを読み込めませんでした',
    gameLoading: '今日の5セットを準備中…',
    backVault: 'コレクションに戻る',
    gameDoneSub: '今日の5問は完了しました',
    gameRound: 'デイリーチャレンジ・ラウンド {n}/{total}',
    gameDaily: 'デイリーチャレンジ',
    gameTitle: 'Price It!',
    wrShareFailed: 'ストーリー画像を作成できませんでした',
    wrSaved: '{name}を保存しました',
    wrShareTitle: '私の Brick Wrapped {year}',
    wrEmptyAction: 'セットを追加',
    wrEmptyBody: 'セットをいくつか追加すると、Wrappedが自動で完成します。',
    wrEmptyTitle: 'コレクションは始まったばかりです。',
    wrSlide: 'スライド {n}/{total}',
    wrStory: 'ストーリー',
    wrPrev: '前へ',
    wrNext: '次へ',
    wrClose: '閉じる',
    wrShare: 'ストーリーを共有',
    wrTopTheme: 'あなたのトップテーマ',
    wrThemeYear: '今年のテーマ',
    wrRealizedOther: '{count}件の売却で確定',
    wrRealizedOne: '{count}件の売却で確定',
    wrBest: 'ベストパフォーマー：{name}',
    wrThemesOther: '{count}テーマ',
    wrThemesOne: '{count}テーマ',
    wrPiecesThemesOther: '{count}テーマ・{pieces}ピース',
    wrPiecesThemesOne: '{count}テーマ・{pieces}ピース',
    wrSetsOther: '{count}セット',
    wrSetsOne: '{count}セット',
    wrBuilt: '{value}のコレクションを築きました。',
    wrEyebrow: 'Brick Wrapped {year}',
    withdrawFailed: '取り下げられませんでした',
    withdrawn: '取り下げました',
    openVault: 'コレクションを開く',
    contribEmptyBody: 'セットの「コミュニティ」タブから、写真・販売価格・修正を投稿できます。',
    contribEmptyTitle: '投稿はまだありません',
    noApproved: '承認済みの投稿はまだありません。',
    noPending: '審査待ちの投稿はありません。',
    filterApproved: '承認済み',
    filterPendingN: '審査中・{count}',
    filterPending: '審査中',
    filterAll: 'すべて',
    filterLabel: '投稿の表示',
    notAddedNote: '追加されませんでした — {note}',
    notAdded: '追加されませんでした',
    statusDeclined: '却下',
    statusApproved: '承認済み',
    approvedOn: '承認済み・{date}',
    withdraw: '取り下げる',
    waiting: '審査待ち',
    kindData: 'データの修正',
    kindMetadata: 'データの修正',
    ...
    goalDone: '最高ランクのバッジを獲得しました。ありがとうございます！',
    goalGoldOther: 'ゴールドバッジまであと{count}件',
    goalGoldOne: 'ゴールドバッジまであと{count}件',
    goalContributorOther: 'コントリビューターバッジまであと{count}件',
    goalContributorOne: 'コントリビューターバッジまであと{count}件',
    tierGold: 'ゴールドコントリビューター',
    tierContributor: 'コントリビューター',
    approvedWord: '件承認',
    contribSub: '共有した写真・価格・修正',
    contribTitlePage: 'あなたの投稿',
    linkCopied: 'リンクをコピーしました',
    shareTitle: '{name}さんのLEGOコレクション',
    shareLink: 'リンクを共有',
    turnOn: 'オンにする',
    previewBanner: '公開プロフィールをオンにするまで、このページはあなたにしか見えません。',
    yourProfileSub: 'あなたの公開プロフィール',
    previewSub: '公開プロフィールのプレビュー',
    publicProfile: '公開プロフィール',
    notFoundBody: 'このプロフィールは非公開か、リンクが間違っています。',
    notFoundTitle: 'プロフィールが見つかりません',
    otherTheme: 'その他',
    topThemes: '主なテーマ',
    addToShelf: 'トロフィー棚に追加',
    shelfEmpty: 'このコレクターはまだトロフィー棚に何も飾っていません。',
    shelfCount: 'トロフィー棚・{max}枠中{count}',
    shelf: 'トロフィー棚',
    pieces: 'ピース',
    setsLabelOther: 'セット',
    setsLabelOne: 'セット',
    value: '評価額',
    valueHiddenShort: '評価額・非表示',
    valueShown: '評価額・表示中',
    since: '{year}年から収集',
    ...
    goPublic: '公開する',
    private: 'プロフィールは非公開です',
    valueHidden: '評価額は非表示です',
    noHandle: 'ハンドルを決めてプロフィールを公開しましょう',
    wouldBe: 'あなたは{total}件中{rank}位です',
    signIn: 'サインイン',
    joinGuest: 'サインインしてプロフィールを公開しましょう',
    joinTitle: 'ランキングに参加',
    topOf: '公開コレクション{total}件中の上位{shown}件',
    risingEmptyBody: '「上昇中」は各コレクションを1か月前と比べます。30日分の履歴がたまると表示されます。',
    risingEmptyTitle: '上昇中のコレクションはまだありません',
    emptyBody: 'プロフィールを公開して評価額を表示すると、最初にランキングに載れます。',
    emptyTitle: '公開コレクションはまだありません',
    you: 'あなた',
    pro: 'Pro',
    setsOther: '{count}セット',
    setsOne: '{count}セット',
    ...
    byValue: '評価額',
    rankBy: 'コレクションの並べ替え',
    subRising: '30日間の上昇率トップ',
    subSets: '規模順の公開コレクション',
    subValue: '評価額順の公開コレクション',
    leaderboard: 'ランキング',
  },
  // 2026 redesign · First screens (one group per area).
  bvFirst: {
    lockPin: 'PINを使う',
    lockHint: 'センサーに触れてロック解除',
    lockUnlock: '指紋でロック解除',
    lockSub: '最近使ったアプリの画面では評価額が隠れます。',
    lockTitle: 'BricksVaultはロックされています',
    notFoundBody: 'リンクが古いか、入力に誤りがある可能性があります。',
    notFoundTitle: 'ページが見つかりません',
    browseCatalog: 'カタログを見る',
    goVault: 'コレクションへ',
    errorBody: 'コレクションのデータは失われていません。接続を確認して、もう一度お試しください。',
    errorTitle: 'このページを読み込めませんでした',
    retry: '再試行',
    reachNoSaved: '接続を確認して、もう一度お試しください。',
    reachSaved: '{time}時点の保存済みの評価額を表示しています。',
    reachTitle: 'BricksVaultに接続できません',
    syncCount: '{total}件中{done}件',
    syncing: '価格を更新中',
    pendingSyncOther: 'オンラインに戻ると{count}件の変更が同期されます',
    pendingSyncOne: 'オンラインに戻ると{count}件の変更が同期されます',
    valuesFrom: '{time}時点の評価額',
    offline: 'オフライン',
    openVault: 'コレクションを開く',
    alertsFailed: 'アラートをオンにできませんでした。通知の設定からもう一度お試しください。',
    alertsBlocked: '通知が設定でブロックされています。後で設定から許可できます。',
    alertsOnToast: 'アラートをオンにしました',
    turnOnAlerts: 'アラートをオンにする',
    notNow: '今はしない',
    alertsAskBody: '廃番、大きな値動き、ほしい物リストの目標価格をお知らせします。このあと端末が許可を求めます。',
    alertsAsk: '価格が動いたら通知しますか？',
    mostValuable: '高価なセット',
    readyLookOther: '{count}件は確認が必要',
    readyLookOne: '{count}件は確認が必要',
    readyFigsOther: 'ミニフィグ{count}体',
    readyFigsOne: 'ミニフィグ{count}体',
    readySetsOther: '{count}セット',
    readySetsOne: '{count}セット',
    readyTitle: 'コレクションの準備ができました',
    importSignInBody: 'Bricksetからの取り込みはアカウントに保存され、すべての端末で同期されます。',
    importSignInTitle: '取り込むにはサインイン',
    seeVault: 'コレクションを見る',
    justAdded: '追加されたセット',
    ...
    importOf: '{total}セット中',
    importFailedTitle: '取り込みが止まりました',
    importFailedToast: 'Bricksetの取り込みが止まりました。連携からもう一度お試しください。',
    importDoneToastOther: 'Bricksetの取り込み完了：{count}セット追加',
    importDoneToastOne: 'Bricksetの取り込み完了：{count}セット追加',
    importBackground: '取り込みは続いています。終わったらお知らせします。',
    keepUsing: 'アプリを使い続ける',
    importWorking: 'セットを取り込んで評価しています。',
    importing: '取り込み中…',
    importLeave: '画面を離れても大丈夫 — 終わったらお知らせします',
    bsMissing: 'Bricksetのユーザー名とパスワードを入力してください。',
    bsConnect: '連携して取り込む',
    bsHelp: 'アカウント連携に一度だけ使います。保存するのはBricksetのアクセストークンのみです。',
    bsPass: 'Brickset パスワード',
    bsUser: 'Brickset ユーザー名',
    importConnectSub: '始めるにはBricksetアカウントを連携してください',
    importTitle: 'Bricksetから取り込み中',
    laterDo: '後でやる',
    fillSearchSub: '組み立て済み・箱なしのセットに',
    fillSearch: '名前や番号で検索',
    fillScanSub: 'バーコードにかざすだけ',
    fillScan: '箱を1つずつスキャン',
    fillBricklinkSub: '注文のCSVをアップロード',
    fillBricklink: 'BrickLinkの注文',
    fillBricksetSub: 'Bricksetのコレクションをまとめて取り込み',
    fillBrickset: 'Bricksetから取り込む',
    fillShelfSub: '1枚の写真ですべての箱を認識 — 10セット以上におすすめ',
    fillShelf: '棚を撮影する',
    fastest: '最速',
    fillLead: 'あなたのコレクションに合った一番速い方法を選んでください。組み合わせもできます。',
    fillTitle: 'コレクションを登録しましょう',
    stepOf: 'ステップ {n}/{total}',
    continue: '続ける',
    later: '後で',
    alertsSub: '最初の目標価格を設定するときに確認します',
    alerts: '価格アラート',
    modeKids: 'キッズ',
    modeSimple: 'シンプル',
    useChange: 'プロフィールでいつでも変更できます。',
    useSub: '投資家・シンプル・キッズ',
    use: '使い方',
    skinGold: 'Gold',
    skinPremium: 'Premium',
    ...
    themeDark: 'ダーク',
    themeLight: 'ライト',
    styleLocked: 'PremiumとGoldはBricksVault Proで解除されます',
    styleHelp: 'PremiumとGoldはProで使えます。',
    style: 'スタイル',
    theme: 'テーマ',
    lookSubAuto: '端末の設定に合わせる',
    lookSub: 'テーマとスタイル',
    look: '外観',
    marketHelp: '店舗の販売情報の取得元です。転売価格はあなたの通貨のままです。',
    marketSub: '店頭価格と在庫用',
    market: '小売市場',
    currencyHelp: '評価額はこの通貨で表示されます。',
    currencySub: '地域から判定',
    currency: '通貨',
    languageSub: '端末の設定に合わせる',
    language: '言語',
    signIn: 'サインイン',
    welcomeLead: 'お使いの端末に合わせて設定しました。今すぐ、または後からプロフィールで変更できます。',
    welcomeName: 'ようこそ、{name}さん',
    welcome: 'ようこそ',
    skip: 'スキップ',
    privacy: 'プライバシーポリシー',
    terms: '利用規約',
    loginAgree: '続行すると{terms}と{privacy}に同意したことになります。',
    loginGuestNote: 'ゲストのコレクションはこの端末に保存されます。',
    loginGuest: 'アカウントなしで試す',
    loginEmail: 'メールアドレスを使う',
    loginApple: 'Appleで続ける',
    loginGoogle: 'Googleで続ける',
    loginSub: '評価額を追跡し、値下がりや廃番を見逃さず、手持ちのパーツで何が作れるかもわかります。',
    loginTitle: 'あなたのブロックの価値がわかる。',
  },
  shell: {
