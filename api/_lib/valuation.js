// Formula-based valuation for bulk imports (no AI call needed)
// retail_price ≈ pieces × $0.11 × theme_multiplier × year_factor
// market_value ≈ retail × 1.1 (active) or retail × 1.4 (retired)

const THEME_MULTIPLIERS = {
  'Star Wars': 1.35,
  'Technic': 1.20,
  'Ideas': 1.25,
  'Icons': 1.15,
