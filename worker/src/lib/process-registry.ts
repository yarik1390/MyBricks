...
export const PROCESS_REGISTRY: Record<string, ProcessInfo> = {
  ...
  'ebay-sold-scrape': { label: 'eBay sold comps', description: 'Scrapes eBay realized sold prices (Bright Data, rotating tokens) as a high-confidence sold source.', schedule: '6×/day (every 4h)', group: 'Pricing' },
