...
export default defineConfig({
  testDir: '.',
  testMatch: process.env.PW_MATCH || /(smoke|i18n|i18n-dict|scan-layout|card-badge-layout|release-regressions|design-audit-regressions|audit-admin-integrations-data|llm-console|vault-animation)\.spec\.mjs$/,
  timeout: 30000,
  expect: { timeout: 7000 },
