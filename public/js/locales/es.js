...
export const es = {
  ...
  bvVault: {
    ...
    buildSearch: 'Buscar construcciones',
    buildAltsTabPlain: 'Modelos alternativos',
    buildAltsTabOther: 'Modelos alternativos · {count}',
    buildAltsTabOne: 'Modelos alternativos · {count}',
    buildTryAnother: 'Prueba con otro nombre.',
    buildNoMatches: 'No hay construcciones que mostrar',
    buildNoMatchesFor: 'Ninguna construcción coincide con «{query}»',
    buildAltsIndexingBody: 'Los modelos alternativos se indexan unos pocos sets a la vez. Vuelve más tarde.',
    buildAltsIndexingTitle: 'Buscando modelos alternativos',
    buildIndexingBody: 'Estamos indexando las piezas de tus sets. Vuelve en unos minutos.',
    buildIndexingTitle: 'Contando tus piezas',
    buildNothingBody: 'Añade sets a tu colección y te mostraremos qué más puedes construir con sus piezas.',
    buildNothingTitle: 'Aún no hay nada con qué construir',
    buildUnavailable: 'Sugerencias de construcción no disponibles',
    buildScan: 'Escanear un montón de piezas',
    buildSignIn: 'Iniciar sesión',
    buildSignInBody: 'Comparamos las piezas de tus sets con el catálogo de LEGO. Para ello necesitamos tu colección sincronizada.',
    buildSignInTitle: 'Inicia sesión para ver qué puedes construir',
    buildNote: 'Construir uno implica desmontar sets que tienes. Tu colección y sus valores no cambian.',
    buildNearOther: '{count} más al 80 %+',
    buildNearOne: '{count} más al 80 %+',
    buildReadyCountOther: '{count} listas',
    buildReadyCountOne: '{count} lista',
    buildFromPartsOther: 'Con las piezas de tus {count} sets',
    buildFromPartsOne: 'Con las piezas de tu {count} set',
    buildAltsNote: 'Los modelos alternativos son diseños de fans de Rebrickable. Las instrucciones se abren en su web.',
    buildAltsSetsOther: 'de {count} sets',
    buildAltsSetsOne: 'de {count} set',
    buildAltModelsOther: '{count} modelos',
    buildAltModelsOne: '{count} modelo',
    buildAltsFromOther: 'Modelos alternativos para tus {count} sets',
    buildAltsFromOne: 'Modelos alternativos para tu {count} set',
    buildInstructions: 'Instrucciones',
    buildUntitled: 'Modelo sin nombre',
    buildFrom: 'con {set}',
    buildBy: 'de {designer}',
    buildPctLabel: '{pct} % de las piezas en tu colección',
    buildReady: 'Lista',
    buildPartsMissingOther: 'faltan {count} piezas',
    buildPartsMissingOne: 'falta {count} pieza',
    buildAllParts: 'Todas las piezas en tu colección',
    buildPiecesOther: '{count} piezas',
    buildPiecesOne: '{count} pieza',
    buildAltsLoadFailed: 'No se pudieron cargar los modelos alternativos',
    buildLoadFailed: 'No se pudieron cargar los sets construibles',
    exportListsSub: 'Descarga tus listas en JSON',
    listsEmptyTitle: 'Aún no hay listas',
    searchListsPlaceholder: 'Nombre de lista o set',
    searchLists: 'Buscar listas',
    listOnWishlistShort: 'En la lista de deseos',
    listNotOwnedOther: 'te faltan {count}',
    listNotOwnedOne: 'te falta {count}',
    listOnWishlistOther: '{count} en tu lista de deseos',
    listOnWishlistOne: '{count} en tu lista de deseos',
    listWantedOther: '{count} buscados',
    listWantedOne: '{count} buscado',
    recordsAllDone: 'No falta nada: todos los registros están completos.',
    addDate: 'Añadir fecha',
    recordsOpen: 'Abrir',
    recordsIncomplete: 'Sets incompletos',
    recordsMissingDate: 'Falta la fecha de compra',
    recordsMissingPrice: 'Falta el precio pagado',
    recordsComplete: '{pct} % completo',
    recordsTitle: 'Registros de la colección',
    listDeleted: 'Lista eliminada',
    listSaved: 'Lista guardada',
    deleteList: 'Eliminar lista',
    editList: 'Editar lista',
    newList: 'Nueva lista',
    figSourceBlend: 'Estimación de mercado combinada',
    figSourceBl: 'vía guía de precios de BrickLink',
    figSourceBlEbay: 'vía BrickLink + ventas en eBay',
    figRebrickable: 'Ver en Rebrickable',
    figRemove: 'Quitar de la colección',
    figOptional: 'Opcional',
    figPricePaid: 'Precio pagado',
    figOneMore: 'Una más',
    figOneFewer: 'Una menos',
    figCopies: 'Copias',
    figFirstSeen: 'Desde {year}',
    figComesIn: 'Viene en',
    figMarketValue: 'Valor de mercado',
    figMinifig: 'Minifigura',
    figInVault: 'En tu colección',
    figEditOwned: '{name} está en tu colección: editar',
    figAddOne: 'Añadir {name} a tu colección',
    figAdded: '{name} añadida a tu colección',
    figLoadFailed: 'No se pudieron cargar las minifiguras',
    figClearFilters: 'Borrar filtros',
    figNoMatches: 'No se encontraron minifiguras',
    figEmptyBody: 'Añade las figuras que tienes para seguir su valor y completar series.',
    figEmptyTitle: 'Aún no tienes minifiguras',
    figExportSub: 'Tus figuras, copias y precios en CSV',
    figApply: 'Aplicar',
    figClearAll: 'Borrar todo',
    figOwnership: 'Posesión',
    figRarity: 'Rareza',
    figFiltersSub: 'Rareza, serie y orden',
    figFiltersTitle: 'Filtros de minifiguras',
    figSortNameDesc: 'Nombre Z–A',
    figSortNameAsc: 'Nombre A–Z',
    figSortValueAsc: 'Valor: de menor a mayor',
    figSortValueDesc: 'Valor: de mayor a menor',
    figSortYearAsc: 'Más antiguas primero',
    figSortYearDesc: 'Más nuevas primero',
    figSortScarcityAsc: 'Más comunes: en más sets',
    figSortScarcity: 'Más raras: en menos sets',
    figSortRarityAsc: 'Rareza: comunes primero',
    figSortRarityDesc: 'Rareza: legendarias primero',
    figSortZa: 'Z–A',
    figSortOldest: 'Más antiguas',
    figSortYear: 'Más nuevas',
    figSortRarest: 'Más raras',
    figSortRarity: 'Rareza',
    figSortTitle: 'Ordenar',
    figNotOwned: 'No las tengo',
    figYours: 'Tus minifiguras',
    figFind: 'Buscar',
    figBrowse: 'Explorar minifiguras',
    figComplete: 'Completa',
    figToFindOther: 'faltan {count}',
    figToFindOne: 'faltan {count}',
    figSeriesOwnedOfOther: '{series} · tienes {owned} de {count}',
    figSeriesOwnedOfOne: '{series} · tienes {owned} de {count}',
    figSeriesOfOther: '{series} · {owned} de {count}',
    figSeriesOfOne: '{series} · {owned} de {count}',
    figSeriesCountOther: '{count} figuras',
    figSeriesCountOne: '{count} figura',
    figSeriesTitle: 'Serie',
    figAllSeries: 'Todas las series',
    figSearchPlaceholder: 'Nombre o serie',
    figSearchLabel: 'Buscar minifiguras',
    figSearchOwned: 'Buscar en tus minifiguras',
    figResultsOther: '{count} minifiguras',
    figResultsOne: '{count} minifigura',
    figUniqueOther: '{count} distintas',
    figUniqueOne: '{count} distinta',
    figFiguresOther: '{count} figuras',
    figFiguresOne: '{count} figura',
    figSummaryLabel: 'Resumen de tus minifiguras',
    figValue: 'Valor de minifiguras',
    quietBody: 'Ahora mismo no hay nada pendiente. Aquí verás objetivos alcanzados, retiradas y grandes movimientos.',
    quietTitle: 'Todo tranquilo',
    retiringWishedSub: 'En tu lista de deseos · últimos meses a precio oficial',
    retiringOwnedSubOther: 'Tienes {count} · se retira pronto',
    retiringOwnedSubOne: 'Tienes {count} · se retira pronto',
    actionBuy: 'Comprar',
    actionHold: 'Conservar',
    actionSell: 'Vender',
    actionOffers: 'Ofertas',
    alertSpikeSub: 'Ahora {price}; pagaste {paid}',
    alertSpikeTitle: '{name} ha subido un {pct}',
    alertSellSub: 'Tu objetivo de venta era {target}',
    alertSellTitle: '{name} llegó a {price}',
    alertDropSub: 'Por debajo de tu objetivo de {target}',
    alertDropTitle: '{name} está a {price}',
    moversTitleOther: 'Mayores movimientos · {count} días',
    moversTitleOne: 'Mayores movimientos · {count} día',
    retiringTitle: 'Se retira pronto · LEGO.com',
    needsYou: 'Te necesita',
    noHistoryYet: 'Los cambios de valor aparecen tras la próxima valoración diaria',
    needsLookOther: '{count} cosas por revisar',
    needsLookOne: '{count} cosa por revisar',
    collectionNow: 'Colección ahora {value}',
    changesSub: '{since} · {date}',
    alertSettings: 'Ajustes de alertas',
    proNotNow: 'Ahora no',
    proSignIn: 'Inicia sesión o crea una cuenta',
    proSettings: 'Abrir ajustes de Pro',
    proWeb: 'Ver opciones de apoyo web',
    proPerkExport: 'Columnas de valor de mercado y rentabilidad al exportar',
    proPerkSignals: 'Señales de inversor, movimientos y radar de retiradas',
    proBody: 'Inicia sesión para vincular Pro a tu colección. Llevar tu colección sigue siendo gratis.',
    proTitle: 'BricksVault Pro',
    riskScore: 'Riesgo {score} %',
    riskNone: 'Sin sets activos de alto riesgo (≥ 70)',
    riskTitle: 'Riesgo de retirada',
    partOutBody: 'Sets que ahora valen más vendidos por piezas que precintados.',
    partOutTitle: 'Oportunidades de vender por piezas',
    perWeek: '{pct} %/sem',
    noFalling: 'Sin bajadas destacables',
    noRising: 'Sin subidas destacables',
    topFalling: 'A la baja',
    topRising: 'Al alza',
    slopeTitle: 'Mayores movimientos · tendencia 90 días',
    sp500Index: 'S&P {value}',
    sp500Vault: 'Colección {value}',
    sp500Body: 'Tu valor LEGO (verde) frente al mismo dinero en el S&P 500 al 8 % anual (discontinua), invertido al comprar.',
    sp500Title: 'Comparación con el S&P 500',
    signalsCold: 'Ocasiones de compra: reventa bajo mercado',
    signalsHot: 'Señales de venta: reventa al alza',
    signalsTitle: 'Señales de mercado',
    teaserFree: 'Llevar tu colección seguirá siendo gratis, siempre.',
    teaserCta: 'Ver opciones Pro',
    teaserHistory: 'Historial completo de 1 año',
    teaserSp500: 'Comparación con el S&P 500 y reparto',
    teaserRadar: 'Radar de retiradas y oportunidades de vender por piezas',
    teaserMovers: 'Mayores movimientos y rezagados',
    teaserSignals: 'Señales de compra y venta en tus sets',
    teaserTitle: 'Análisis de inversor: herramientas Pro',
    toolkitTitle: 'Herramientas de inversor',
    confidenceTitle: 'Confianza de la valoración',
    topLosers: 'Por debajo de lo que pagaste',
    topGainers: 'Mayores subidas',
    radarRetiringOther: '{count} se retiran pronto',
    radarRetiringOne: '{count} se retira pronto',
    radarRetiredOther: '{retired} de {count} sets están retirados',
    radarRetiredOne: '{retired} de {count} set está retirado',
    radarTitle: 'Radar de retiradas',
    themeShare: '{theme}: {pct} % del valor',
    byTheme: 'Por tema',
    statRealizedNone: 'Realizado',
    statRealizedOther: 'Realizado · {count} ventas',
    statRealizedOne: 'Realizado · {count} venta',
    statPaper: 'Ganancia latente',
    statPaid: 'Pagado (sets con precio)',
    statValue: 'Valor',
    legendSalesOther: '{count} ventas',
    legendSalesOne: '{count} venta',
    legendSold: 'Vendido: {name}',
    legendPaid: 'Pagado',
    legendValue: 'Valor',
    chartEmpty: 'Tu historial de valor empieza tras la próxima valoración diaria.',
    chartSummary: '{change} en {range}',
    rangeSpanALL: 'todo tu historial',
    rangeSpan1Y: 'el último año',
    rangeSpan3M: 'los últimos 3 meses',
    rangeSpan1M: 'el último mes',
    rangeProToast: 'El historial de más de 90 días es de Pro; mostramos los últimos 90 días.',
    rangeLocked: '{range} (Pro)',
    rangeAll: 'Todo',
    rangeLabel: 'Periodo',
    insightsEmptyBody: 'Añade sets para ver el historial de valor, los temas y las ganancias.',
    insightsEmptyTitle: 'El análisis empieza con tu primer set',
    insightsSubtitle: 'Colección · {sets}',
    emptyBrowse: 'Explorar el catálogo',
    emptyScanSub: 'Un código de barras cada vez',
    emptyScanTitle: 'Escanear una caja',
    emptyImportSub: 'Trae una lista que ya tengas',
    emptyImportTitle: 'Importar de Brickset o BrickLink',
    emptyShelfSub: 'Añade muchos sets con una foto',
    emptyShelfTitle: 'Fotografía una estantería',
    emptyBody: 'Añade tus primeros sets y los valoraremos en segundos.',
    emptyTitle: 'Tu estantería está vacía',
    brick3dUnavailable: 'El 3D no está disponible ahora',
    csvExported: 'CSV exportado',
    restored: 'Restaurado en tu colección',
    bulkRemovedOther: '{count} sets quitados',
    bulkRemovedOne: '{count} set quitado',
    bulkDeleteConfirm: 'Quitar',
    bulkDeleteMessageOther: '¿Quitar {count} sets de tu colección? Podrás deshacerlo justo después.',
    bulkDeleteMessageOne: '¿Quitar {count} set de tu colección? Podrás deshacerlo justo después.',
    bulkDeleteTitle: '¿Quitar sets?',
    bulkLocationDone: 'Ubicaciones actualizadas',
    bulkLocationUpdating: 'Actualizando ubicaciones…',
    bulkNoMatch: 'Ninguno de los sets seleccionados sigue en tu colección',
    bulkLocationPlaceholder: 'p. ej., Armario A, balda 2',
    bulkLocationLabel: '¿Dónde guardas los sets seleccionados?',
    bulkLocationTitle: 'Lugar de almacenamiento',
    bulkCsv: 'CSV',
    bulkLocation: 'Ubicación',
    selectedCountOther: '{count} sets seleccionados',
    selectedCountOne: '{count} set seleccionado',
    selectHint: 'Toca los sets para seleccionarlos',
    shareUnavailable: 'Compartir no está disponible en este dispositivo',
    linkCopied: 'Enlace copiado',
    howWePrice: 'Cómo valoramos',
    gameStreakOther: 'racha de {count} días',
    gameStreakOne: 'racha de {count} día',
    gamePlayed: 'Jugado · {score}/5 hoy',
    gameSub: 'Adivina el valor de mercado y suma racha',
    priceGame: 'Price It!: los 5 sets de hoy',
    sharePublicProfile: 'Compartir perfil público',
    exportCollectionSub: 'CSV o informe para el seguro',
    exportCollection: 'Exportar colección',
    collectionRoomSub: 'Recorre tus estanterías en 3D',
    collectionRoom: 'Sala de la colección',
    showAsList: 'Ver en lista',
    showAsGrid: 'Ver en cuadrícula',
    insightsSub: 'Historial de valor, temas y ganancias',
    unreadAlertsOther: '{count} alertas nuevas',
    unreadAlertsOne: '{count} alerta nueva',
    whatChangedSub: 'Alertas, retiradas y movimientos',
    whatChanged: 'Qué ha cambiado',
    selectSetsSub: 'Mueve, exporta o elimina varios a la vez',
    selectSets: 'Seleccionar sets',
    moreGroupShare: 'Compartir y extras',
    footUpdatedDate: 'valores actualizados el {date}',
    footUpdatedYesterday: 'valores actualizados ayer a las {time}',
    footUpdatedToday: 'valores actualizados hoy a las {time}',
    footPiecesOther: '{count} piezas',
    footPiecesOne: '{count} pieza',
    footSetsOther: '{count} sets',
    footSetsOne: '{count} set',
    addPrice: 'Añadir precio',
    pinnedLists: 'Listas fijadas',
    changeMoreOther: '{count} más',
    changeMoreOne: '{count} más',
    changeRetiring: '{name} se retira pronto',
    changeSpike: '{name} subió de valor',
    changeSellTarget: '{name} alcanzó tu precio de venta',
    changeDrop: '{name} alcanzó tu precio objetivo',
    sinceValueMoved: 'Tu colección varió un {pct}',
    sinceWithAmount: '{since}: {amount}',
    sinceDate: 'Desde el {date}',
    sinceWeekday6: 'Desde el sábado',
    sinceWeekday5: 'Desde el viernes',
    sinceWeekday4: 'Desde el jueves',
    sinceWeekday3: 'Desde el miércoles',
    sinceWeekday2: 'Desde el martes',
    sinceWeekday1: 'Desde el lunes',
    sinceWeekday0: 'Desde el domingo',
    sinceYesterday: 'Desde ayer',
    heroLoadFailed: 'No se pudo conectar con BricksVault; inténtalo pronto',
    heroUsd: 'En USD hasta que carguen los tipos de cambio',
    heroOffline: 'Sin conexión · valores guardados',
    trendSoon: 'Tu línea de tendencia empieza tras la próxima valoración diaria',
    addPricesForGain: 'Añade lo que pagaste para ver tu ganancia',
    realizedFromOther: '{amount} realizados en {count} ventas',
    realizedFromOne: '{amount} realizados en {count} venta',
    onPaper: '{amount} sobre el papel',
    insights: 'Análisis',
    ...
    layoutList: 'Lista',
    layout: 'Vista',
    sortAzSub: 'Por nombre, alfabéticamente',
    sortAz: 'A–Z',
    sortGrowthSub: 'Mejor rentabilidad anual primero',
    sortGrowth: 'Crecimiento',
    sortValueSub: 'Los más valiosos primero',
    sortValue: 'Valor',
    sortRecentSub: 'Los últimos añadidos primero',
    sortRecent: 'Recientes',
    sortTitle: 'Ordenar sets',
    sortCurrent: 'Orden: {sort}',
    searchPlaceholder: 'Nombre, tema o número de set',
    moreOptions: 'Más opciones',
    closeSearch: 'Cerrar búsqueda',
    searchVault: 'Buscar en tu colección',
  },
  ...
  shell: {
    tabSets: 'Sets',
    tabMinifigs: 'Minifiguras',
    tabLists: 'Listas',
    tabBuild: 'Construir',
    scanToAdd: 'Escanear',
    alertsOne: '{count} alerta',
    alertsOther: '{count} alertas',
  },
  setup: {
  ...
  "grid": "Cuadrícula",
  "room": "Sala 3D",
  "view": "Vista de colección",
  "sets": "Sets",
  "minifigures": "Minifiguras",
  "collections": "Colecciones",
  "collectionTabs": "Tu colección",
  "discover": "Descubrir",
  "profile": "Perfil",
  "wishlist": "Deseos",
  "add": "Añadir",
  "addTitle": "Añadir a tu colección",
  "addHint": "Escanea una caja o encuentra un set que te guste.",
  "scan": "Escanear un set",
  "searchCatalog": "Buscar en el catálogo",
  "manual": "Introducir número del set",
  "setNumber": "Número del set",
  "findSet": "Encontrar set",
  "search": "Buscar en tu colección",
  "catalogSearch": "Buscar nombre o número del set",
  "buildIdeas": "Ideas para construir",
  "advisor": "Preguntar al asesor",
  "insights": "Resumen de la colección",
  "ownedOne": "{count} set en tu bóveda",
  "ownedOther": "{count} sets en tu bóveda",
  "emptyTitle": "Tu colección empieza aquí",
  "emptyHint": "Añade tu primer set y explora tu colección en tu propia sala 3D.",
  "noResults": "Ningún set coincide con tu búsqueda",
  "clearSearch": "Borrar búsqueda",
  "pin": "Fijar colección",
  "unpin": "Desfijar colección",
  "pinned": "Fijadas en este dispositivo",
  "preferenceFailed": "No se pudo guardar esta preferencia en tu dispositivo.",
  "passport": "Pasaporte de colección",
  "passportHint": "La historia de tu set. Fotos, recuerdos y el día que lo encontraste.",
  "editEntry": "Editar ficha de colección",
  "viewPassport": "Abrir pasaporte de colección",
  "owned": "En tu bóveda",
  "wanted": "En tu lista de deseos",
  "target": "Tu precio objetivo: {price}",
  "ownershipUnknown": "Abre los detalles para consultar tu colección.",
  "cachedOwnership": "Se usa la última colección cargada.",
  "savePending": "Cambios pendientes de sincronizar",
  "saveFailed": "Algunos cambios requieren atención",
  "nextScan": "Escanear otro",
  "money": "Valor e información del mercado"
},
  collections: {
  ...
  common: {
    actionFailed: 'No ha funcionado. Inténtalo de nuevo',
    back: 'Atrás',
  ...
  market: {
    ...
    soldEvidenceHeadline: 'Basado en {sales} de {markets}.',
    soldEvidenceFallback: 'No hay ventas verificadas recientes; la estimación usa precios anunciados o guías de mercado.',
    soldEvidenceTitle: 'Ventas de referencia',
    soldEvidenceNewSealed: 'Nuevo y sellado',
    soldEvidenceUsedComplete: 'Usado y completo',
    soldEvidenceFresh: 'Reciente',
    soldEvidenceOlder: 'Anterior',
    soldEvidenceSalesOne: '1 venta verificada',
    soldEvidenceSalesOther: '{n} ventas verificadas',
    soldEvidenceMarketplacesOne: '1 mercado',
    soldEvidenceMarketplacesOther: '{n} mercados',
    partOutVerdictPartout: 'Desmontarlo da más',
    partOutVerdictSealed: 'Véndelo sellado',
    partOutVerdictSame: 'Casi lo mismo',
    partOutSellSealed: 'Vender sellado',
    partOutSellParts: 'Vender por piezas',
    partOutDeltaPartout: '{pct} más que el valor sellado',
    partOutDeltaSealed: 'el valor sellado es un {pct} mayor',
    partOutClose: 'los valores son parecidos',
    partOutCoverage: '{pct} de las piezas con precio',
...
Object.assign(es.wishlist, { ackAlert: 'Descartar alerta de precio objetivo', alertAcked: 'Alerta descartada' });
...
Object.assign(es.admin, { llmUnavailable: 'Enrutamiento de LLM no disponible', llmMergeBalance: 'Saldo de Merge restante este mes', llmMeteredNote: 'Calculado a partir del coste que Merge informa en cada llamada; su panel es la cifra autorizada.', llmEffective: 'Se ejecuta ahora', llmEffectiveNone: 'ningún proveedor configurado', llmLivePool: 'Grupo gratuito en vivo (automático)', llmNoKey: 'sin clave', llmNoKeyHint: 'Este proveedor no tiene clave de API configurada, así que el paso se omite en ejecución.', llmMoveUp: 'Mover el paso antes', llmMoveDown: 'Mover el paso después', llmOn: 'Activado', llmOff: 'Desactivado', llmReset: 'Restablecer valores por defecto', llmSave: 'Guardar enrutamiento', llmSaved: 'Enrutamiento de LLM guardado', llmSaveFailed: 'No se pudo guardar el enrutamiento de LLM', llmRefreshModels: 'Actualizar modelos de Merge', llmModelsRefreshedOne: '{n} modelo de Merge actualizado', llmModelsRefreshedOther: '{n} modelos de Merge actualizados', llmModelsFailed: 'No se pudo actualizar el catálogo de modelos de Merge' });

Object.assign(es.admin, { llmModelPlaceholder: "proveedor/modelo, p. ej. openai/gpt-5.6-luna" });

Object.assign(es.admin, { llmReload: "Recargar", llmChooseModel: "Elegir modelo", llmCustomModel: "ID de modelo personalizado…", llmSpentOf: "{spent} gastado de {budget}", llmLivePoolShort: "grupo gratuito", llmUnsaved: "Cambios sin guardar", llmModelsOther: "Otros", llmWorkload_scan: "Escaneo de fotos", llmWorkload_advisor: "Asesor de IA", llmWorkload_valuation: "Valoración", llmWorkload_listing: "Borradores de anuncios" });

Object.assign(es.admin, { llmLivePoolHint: "Actualizado a diario desde OpenRouter" });
