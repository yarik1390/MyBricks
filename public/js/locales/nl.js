...
export const nl = {
  ...
  bvAccount: {
    ...
    insColNumber: 'Nummer',
    insPdfCounts: '{sets} sets · {figs} minifiguren · waarden in {currency}',
    insPdfCountsNoFigs: '{sets} sets · waarden in {currency}',
    insPdfNote: 'De waarden zijn marktschattingen voor verzegelde sets per {date}, samengesteld uit recente verkopen en aanbiedingen bij de bronnen die BricksVault volgt. Ze zijn geen taxatie. Methode: bricksvault.app/methodology.html',
    insPdfPage: 'Pagina {page} van {pages}',
    insPdfGenerated: 'Gemaakt met BricksVault',
    insLoadFailed: 'Je hele collectie kon niet worden geladen. Er wordt niets geëxporteerd tot alles geladen is.',
  ...
  bvFirst: {
    lockPin: 'Pincode gebruiken',
    lockHint: 'Raak de sensor aan om te ontgrendelen',
    lockUnlock: 'Ontgrendelen met vingerafdruk',
    lockSub: 'Waarden blijven verborgen in recente apps.',
    lockTitle: 'BricksVault is vergrendeld',
    notFoundBody: 'De link is mogelijk verouderd of verkeerd getypt.',
    notFoundTitle: 'Pagina niet gevonden',
    browseCatalog: 'Catalogus bekijken',
    goVault: 'Naar de kluis',
    errorBody: 'Er is niets uit je kluis verloren gegaan. Controleer je verbinding en probeer het opnieuw.',
    errorTitle: 'Deze pagina is niet geladen',
    retry: 'Opnieuw proberen',
    reachNoSaved: 'Controleer je verbinding en probeer het opnieuw.',
    reachSaved: 'Opgeslagen waarden van {time} worden getoond.',
    reachTitle: 'BricksVault is niet bereikbaar',
    syncCount: '{done} van {total}',
    syncing: 'Prijzen bijwerken',
    pendingSyncOther: '{count} wijzigingen worden gesynchroniseerd als je weer online bent',
    pendingSyncOne: '{count} wijziging wordt gesynchroniseerd als je weer online bent',
    valuesFrom: 'waarden van {time}',
    offline: 'Offline',
    openVault: 'Mijn kluis openen',
    alertsFailed: 'Meldingen konden niet worden aangezet. Probeer het opnieuw bij Meldingen.',
    alertsBlocked: 'Meldingen zijn geblokkeerd in je instellingen. Je kunt ze daar later toestaan.',
    alertsOnToast: 'Meldingen staan aan',
    turnOnAlerts: 'Meldingen aanzetten',
    notNow: 'Niet nu',
    alertsAskBody: 'Sets die uit productie gaan, grote bewegingen en doelen op je verlanglijst. Je telefoon vraagt hierna om toestemming.',
    alertsAsk: 'Een melding als prijzen bewegen?',
    mostValuable: 'Meest waardevol',
    readyLookOther: '{count} verdienen een snelle blik',
    readyLookOne: '{count} verdient een snelle blik',
    readyFigsOther: '{count} minifiguren',
    readyFigsOne: '{count} minifiguur',
    readySetsOther: '{count} sets',
    readySetsOne: '{count} set',
    readyTitle: 'Je kluis is klaar',
    importSignInBody: 'Brickset-imports gaan naar je account en worden zo op al je apparaten gesynchroniseerd.',
    importSignInTitle: 'Log in om te importeren',
    seeVault: 'Naar mijn kluis',
    ...
    importFailedTitle: 'De import is gestopt',
    importFailedToast: 'De Brickset-import is gestopt. Open Integraties om het opnieuw te proberen.',
    importDoneToastOther: 'Brickset-import klaar: {count} sets toegevoegd',
    importDoneToastOne: 'Brickset-import klaar: {count} set toegevoegd',
    importBackground: 'De import loopt door — we laten het weten als hij klaar is.',
    keepUsing: 'App blijven gebruiken',
    importWorking: 'We halen je sets op en waarderen ze.',
    importing: 'Bezig met importeren…',
    importLeave: 'Je kunt weggaan — we laten het weten als het klaar is',
    bsMissing: 'Vul je Brickset-gebruikersnaam en -wachtwoord in.',
    bsConnect: 'Koppelen en importeren',
    bsHelp: 'Eenmalig gebruikt om je account te koppelen; we bewaren alleen het toegangstoken van Brickset.',
    bsPass: 'Brickset-wachtwoord',
    bsUser: 'Brickset-gebruikersnaam',
    importConnectSub: 'Koppel je Brickset-account om te beginnen',
    importTitle: 'Importeren uit Brickset',
    laterDo: 'Ik doe het later',
    fillSearchSub: 'Voor gebouwde sets of zonder doos',
    fillSearch: 'Zoeken op naam of nummer',
    fillScanSub: 'Richt op elke barcode',
    fillScan: 'Dozen één voor één scannen',
    fillBricklinkSub: 'Upload de bestellingen-CSV',
    fillBricklink: 'BrickLink-bestellingen',
    fillBricksetSub: 'Haal je hele Brickset-collectie op',
    fillBrickset: 'Importeren uit Brickset',
    fillShelfSub: 'Elke doos op één foto — ideaal vanaf 10 sets',
    fillShelf: 'Een plank fotograferen',
    fastest: 'Snelst',
    fillLead: 'Kies de snelste manier voor je collectie. Je kunt ze combineren.',
    fillTitle: 'Laten we je kluis vullen',
    stepOf: 'Stap {n} van {total}',
    continue: 'Doorgaan',
    later: 'Later',
    alertsSub: 'We vragen het als je je eerste doelprijs instelt',
    alerts: 'Prijsmeldingen',
    modeKids: 'Kinderen',
    modeSimple: 'Eenvoudig',
    useChange: 'Je kunt dit altijd wijzigen in Profiel.',
    useSub: 'Belegger, Eenvoudig of Kinderen',
    use: 'Hoe je hem gebruikt',
    skinGold: 'Gold',
    skinPremium: 'Premium',
    skinVivid: 'Fel',
    skinModular: 'Modulair',
    ...
    themeDark: 'Donker',
    themeLight: 'Licht',
    styleLocked: 'Premium en Gold worden ontgrendeld met BricksVault Pro',
    styleHelp: 'Premium en Gold horen bij Pro.',
    style: 'Stijl',
    theme: 'Thema',
    lookSubAuto: 'Volgt je telefoon',
    lookSub: 'Thema en stijl',
    look: 'Uiterlijk',
    marketHelp: 'Waar winkelaanbiedingen vandaan komen. Doorverkoopwaarden blijven in je valuta.',
    marketSub: 'Voor winkelprijzen en voorraad',
    market: 'Winkelmarkt',
    currencyHelp: 'Waarden worden in deze valuta getoond.',
    currencySub: 'Herkend aan je regio',
    currency: 'Valuta',
    languageSub: 'Volgt je telefoon',
    language: 'Taal',
    signIn: 'Inloggen',
    welcomeLead: 'Dit hebben we van je telefoon overgenomen. Wijzig alles nu of later in Profiel.',
    welcomeName: 'Welkom, {name}',
    welcome: 'Welkom',
    skip: 'Overslaan',
    privacy: 'Privacybeleid',
    terms: 'Voorwaarden',
    loginAgree: 'Door verder te gaan ga je akkoord met de {terms} en het {privacy}.',
    loginGuestNote: 'Gastkluizen blijven op deze telefoon.',
    loginGuest: 'Probeer zonder account',
    loginEmail: 'E-mail gebruiken',
    loginApple: 'Doorgaan met Apple',
    loginGoogle: 'Doorgaan met Google',
    loginSub: 'Volg de waarde, mis geen prijsdalingen of sets die uit productie gaan en zie wat je met je onderdelen kunt bouwen.',
    loginTitle: 'Weet wat je stenen waard zijn.',
  },
  shell: {
    tabSets: 'Sets',
