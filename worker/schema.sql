...
-- Idempotency ledger for quota/provider-consuming scans. A logical scan is
-- charged once and its terminal response can be replayed safely.
...
-- Append-only security/operations trail for privileged mutations.
