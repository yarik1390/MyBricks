...
describe('image proxy rewrite (media reliability)', () => {
  ...
  it('rewrites allowlisted gallery URLs, including Brickset additional images', () => {
    ...
    expect(out.images[1].startsWith(`${O}/api/img?u=`)).toBe(true);            // Brickset proxied (CDN rejects browser hotlinks)
  });
