...
export const uk = {
  ...
  bvFirst: {
    lockPin: 'Використати PIN',
    lockHint: 'Торкніться сенсора, щоб розблокувати',
    lockUnlock: 'Розблокувати відбитком',
    lockSub: 'Вартість прихована в списку нещодавніх застосунків.',
    lockTitle: 'BricksVault заблоковано',
    notFoundBody: 'Посилання могло застаріти або містить помилку.',
    notFoundTitle: 'Сторінку не знайдено',
    browseCatalog: 'Переглянути каталог',
    goVault: 'До сховища',
    errorBody: 'У вашому сховищі нічого не втрачено. Перевірте з’єднання і спробуйте ще раз.',
    errorTitle: 'Сторінка не завантажилася',
    retry: 'Повторити',
    reachNoSaved: 'Перевірте з’єднання і спробуйте ще раз.',
    reachSaved: 'Показуємо збережену вартість станом на {time}.',
    reachTitle: 'Не вдається з’єднатися з BricksVault',
    syncCount: '{done} з {total}',
    syncing: 'Оновлюємо ціни',
    pendingSyncOther: '{count} зміни синхронізуються, коли ви повернетеся онлайн',
    pendingSyncMany: '{count} змін синхронізуються, коли ви повернетеся онлайн',
    pendingSyncFew: '{count} зміни синхронізуються, коли ви повернетеся онлайн',
    pendingSyncOne: '{count} зміна синхронізується, коли ви повернетеся онлайн',
    valuesFrom: 'вартість станом на {time}',
    offline: 'Офлайн',
    openVault: 'Відкрити сховище',
    alertsFailed: 'Не вдалося увімкнути сповіщення. Спробуйте ще раз у розділі «Сповіщення».',
    alertsBlocked: 'Сповіщення заблоковано в налаштуваннях. Їх можна дозволити там пізніше.',
    alertsOnToast: 'Сповіщення увімкнено',
    turnOnAlerts: 'Увімкнути сповіщення',
    notNow: 'Не зараз',
    alertsAskBody: 'Зняття з виробництва, великі зміни та цілі зі списку бажань. Далі телефон попросить дозвіл.',
    alertsAsk: 'Повідомляти, коли ціни змінюються?',
    mostValuable: 'Найцінніші',
    readyLookOther: '{count} варто швидко переглянути',
    readyLookMany: '{count} варто швидко переглянути',
    readyLookFew: '{count} варто швидко переглянути',
    readyLookOne: '{count} варто швидко переглянути',
    readyFigsOther: '{count} мініфігурки',
    readyFigsMany: '{count} мініфігурок',
    readyFigsFew: '{count} мініфігурки',
    readyFigsOne: '{count} мініфігурка',
    readySetsOther: '{count} набору',
    readySetsMany: '{count} наборів',
    readySetsFew: '{count} набори',
    readySetsOne: '{count} набір',
    readyTitle: 'Ваше сховище готове',
    importSignInBody: 'Імпорт із Brickset іде у ваш обліковий запис, тож синхронізується на всіх пристроях.',
    importSignInTitle: 'Увійдіть, щоб імпортувати',
    seeVault: 'До мого сховища',
    justAdded: 'Щойно додано',
    reviewLaterOther: '{count} · переглянути пізніше',
    reviewLaterMany: '{count} · переглянути пізніше',
    ...
    importFailedTitle: 'Імпорт зупинився',
    importFailedToast: 'Імпорт із Brickset зупинився. Відкрийте «Інтеграції», щоб спробувати ще раз.',
    importDoneToastOther: 'Імпорт із Brickset завершено: додано {count} набору',
    importDoneToastMany: 'Імпорт із Brickset завершено: додано {count} наборів',
    importDoneToastFew: 'Імпорт із Brickset завершено: додано {count} набори',
    importDoneToastOne: 'Імпорт із Brickset завершено: додано {count} набір',
    importBackground: 'Імпорт триває — ми повідомимо, коли він завершиться.',
    keepUsing: 'Продовжити користуватися',
    importWorking: 'Переносимо ваші набори й оцінюємо їх.',
    importing: 'Імпортуємо…',
    importLeave: 'Можете піти — ми повідомимо, коли все буде готово',
    bsMissing: 'Введіть ім’я користувача та пароль Brickset.',
    bsConnect: 'Підключити й імпортувати',
    bsHelp: 'Потрібно один раз, щоб пов’язати обліковий запис; ми зберігаємо лише токен доступу Brickset.',
    bsPass: 'Пароль Brickset',
    bsUser: 'Ім’я користувача Brickset',
    importConnectSub: 'Підключіть обліковий запис Brickset, щоб почати',
    importTitle: 'Імпорт із Brickset',
    laterDo: 'Зроблю пізніше',
    fillSearchSub: 'Для зібраних наборів або без коробки',
    fillSearch: 'Пошук за назвою чи номером',
    fillScanSub: 'Наведіть на кожен штрихкод',
    fillScan: 'Сканувати коробки по одній',
    fillBricklinkSub: 'Завантажте CSV із замовленнями',
    fillBricklink: 'Замовлення BrickLink',
    fillBricksetSub: 'Перенесіть усю колекцію з Brickset',
    fillBrickset: 'Імпорт із Brickset',
    fillShelfSub: 'Усі коробки на одному фото — найкраще для 10+ наборів',
    fillShelf: 'Сфотографувати полицю',
    fastest: 'Найшвидше',
    fillLead: 'Оберіть найшвидший спосіб для вашої колекції. Їх можна поєднувати.',
    fillTitle: 'Наповнімо ваше сховище',
    stepOf: 'Крок {n} з {total}',
    continue: 'Продовжити',
    later: 'Пізніше',
    alertsSub: 'Запитаємо, коли ви встановите першу цільову ціну',
    alerts: 'Цінові сповіщення',
    modeKids: 'Дитячий',
    modeSimple: 'Простий',
    useChange: 'Це можна змінити будь-коли в Профілі.',
    useSub: 'Інвестор, Простий або Дитячий',
    use: 'Як ви користуватиметеся',
    skinGold: 'Gold',
    skinPremium: 'Premium',
    skinVivid: 'Яскравий',
    skinModular: 'Модульний',
    ...
    themeDark: 'Темна',
    themeLight: 'Світла',
    styleLocked: 'Premium і Gold відкриваються з BricksVault Pro',
    styleHelp: 'Premium і Gold доступні з Pro.',
    style: 'Стиль',
    theme: 'Тема',
    lookSubAuto: 'Як на телефоні',
    lookSub: 'Тема та стиль',
    look: 'Вигляд',
    marketHelp: 'Звідки беруться пропозиції магазинів. Ціни перепродажу залишаються у вашій валюті.',
    marketSub: 'Для цін і наявності в магазинах',
    market: 'Роздрібний ринок',
    currencyHelp: 'Вартість показуватиметься в цій валюті.',
    currencySub: 'Визначено за вашим регіоном',
    currency: 'Валюта',
    languageSub: 'Як на телефоні',
    language: 'Мова',
    signIn: 'Увійти',
    welcomeLead: 'Ми взяли ці налаштування з вашого телефона. Змініть будь-що зараз або пізніше в Профілі.',
    welcomeName: 'Вітаємо, {name}',
    welcome: 'Вітаємо',
    skip: 'Пропустити',
    privacy: 'Політикою конфіденційності',
    terms: 'Умовами',
    loginAgree: 'Продовжуючи, ви погоджуєтеся з {terms} та {privacy}.',
    loginGuestNote: 'Гостьове сховище залишається на цьому телефоні.',
    loginGuest: 'Спробувати без облікового запису',
    loginEmail: 'Увійти через email',
    loginApple: 'Продовжити з Apple',
    loginGoogle: 'Продовжити з Google',
    loginSub: 'Стежте за вартістю, не пропускайте знижки й зняття з виробництва та дивіться, що можна зібрати з ваших деталей.',
    loginTitle: 'Дізнайтеся, скільки коштують ваші цеглинки.',
  },
  shell: {
    tabSets: 'Набори',
