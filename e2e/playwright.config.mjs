...
export default defineConfig({
  testDir: '.',
  testMatch: process.env.PW_MATCH || /(smoke|i18n|i18n-dict|scan-layout|card-badge-layout|release-regressions|design-audit-regressions|audit-admin-integrations-data|admin-navigation|admin-issues|llm-console|vault-animation|community-manage-ui|minifig-holdings|subcollections)\.spec\.mjs$/,
  timeout: 30000,
  expect: { timeout: 7000 },
