...
export const en = {
  ...
  bvAccount: {
    ...
    insColNumber: 'Number',
    insPdfCounts: '{sets} sets · {figs} minifigures · values in {currency}',
    insPdfCountsNoFigs: '{sets} sets · values in {currency}',
    insPdfNote: 'Values are market estimates for sealed sets as of {date}, blended from recent sales and listings across the sources BricksVault tracks. They are not an appraisal. Method: bricksvault.app/methodology.html',
    insPdfPage: 'Page {page} of {pages}',
    insPdfGenerated: 'Generated by BricksVault',
    insLoadFailed: 'Couldn\'t load all your holdings. Nothing is exported until the whole collection loads.',
